  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>ac', group = '[A]I [C]reate', mode = { 'n' } },
        { '<leader>at', group = '[A]I [T]est', mode = { 'n', 'v' } },
        { '<leader>ag', group = '[A]I [G]it', mode = { 'n' } },
        { '<leader>am', group = '[A]I [M]odel', mode = { 'n' } },
        { '<leader>as', group = '[A]I [S]can', mode = { 'n' } },
        { '<leader>ap', group = '[A]I [P]rompt', mode = { 'n' } },
      },
    },
  },
